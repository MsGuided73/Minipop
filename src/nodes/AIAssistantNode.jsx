...
export default function AIAssistantNode({ id, data, selected }) {
  ...
  const handleSend = useCallback(async () => {
    ...
    try {
      ...
      const response = await callAI(id, msg, nodes, edges, state.model, { autoContinue: state.autoContinue })
  ...
  }, [input, loading, id, updateNode, callAI, state.model, state.autoContinue, getNodes, getEdges])
